...
<form target='_blank' onSubmit={onSubmit} action="https://formsubmit.co/fe25a84cec925d6615fa45816cd91415"
method='POST'>
...
type="text"
placeholder='EMAIL'
 {...register('email', {required: true, pattern: /^[A-z0-9.%+-]+@[A-z0-9.-]+\.[A-Z]{2,}$/i})}/>
{errors.email && (
  <p className='mt-1 text-primary-500'>
